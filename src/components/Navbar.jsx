...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full bg-white bg-opacity-80 shadow-md z-50">
      ...
      {isOpen && (
        <div className="absolute top-16 left-0 w-64 bg-white bg-opacity-75 shadow-lg border border-gray-200 rounded-r-lg p-4 space-y-4 z-50">
