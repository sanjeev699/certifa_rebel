...
<div className="absolute bottom-20 right-1/4 w-56 h-56 md:w-80 md:h-80 bg-blue-500 opacity-15 rounded-full -rotate-6 animate-ping-slow"></div>
...
<div className="absolute top-0 right-0 w-32 h-32 md:w-48 md:h-48 bg-blue-100 opacity-10 rounded-full -rotate-12 animate-ping-slow"></div>
