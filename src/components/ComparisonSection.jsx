...
<div className="absolute top-10 left-1/4 w-48 h-48 md:w-72 md:h-72 bg-blue-700 opacity-20 rounded-full rotate-12 animate-ping-slow"></div>
...
<div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-40 h-40 md:w-60 md:h-60 bg-blue-200 opacity-10 rounded-full rotate-45 animate-ping-slow"></div>
